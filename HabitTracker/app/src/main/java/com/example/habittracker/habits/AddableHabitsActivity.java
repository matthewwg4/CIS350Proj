...
public class AddableHabitsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Set<HabitTracker> habits = FakeHabitDatabase.getInstance()
                .getHabits((String)getIntent().getStringExtra("search with"),
                        ((String)getIntent().getStringExtra("search by")).equals("ID"));
        if (((String)getIntent().getStringExtra("search by")).equals("tag")) {
            habits = FakeHabitDatabase.getInstance()
                    .getbyTag((String)getIntent().getStringExtra("search with"));
        }
